...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <firmware EXPORT="copy">[CONFIG_DIR]/hello-world.wismote</firmware>
    ...
    <motetype>
      ...
      <firmware EXPORT="copy">[CONFIG_DIR]/../6Lo-ND-host-nodata/hello-world.wismote</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>0.012995731002567056</x>
        <y>-0.11580598754428571</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>7.058102254565177 0.0 0.0 7.058102254565177 542.9082748017111 110.81737050177847</viewport>
    </plugin_config>
    <width>1085</width>
    <z>0</z>
    <height>444</height>
